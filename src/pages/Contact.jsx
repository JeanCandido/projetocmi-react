        ...
        <div className="p-4 flex flex-col items-center justify-center md:flex-row flex-wrap md:gap-8 md:mb-32" >
            ...
            <section className=" flex flex-col gap-4 text-center md:gap-16 ">
                ...
                <div>
                    ...
                    <a href="mailto:cmiengenharia@cmiengenharia.com?subject=CMI Engenharia&body=Quero fazer um orçamento de um elevador" className=" bg-black p-2 rounded-lg text-slate-50 hover:bg-cmi-1 hover:text-black">cmiengenharia@cmiengenharia.com</a>
                </div>
                <div>
