    ...
    return(
        <footer className=" p-4 bg-black w-full h-28 text-slate-50 flex sm:h-24 ">
            ...
            <div id="icons" className=" flex flex-col gap-2 items-center w-1/3 justify-center text-xl sm:flex-row ">
                <a href="https://wa.me/5519999555586?text=Gostaria de contratar um serviço" className=" bg-cmi-4 rounded p-1"><FaWhatsapp/></a>
                <a href="mailto:cmiengenharia@cmiengenharia.com?subject=CMI Enganharia&cc=copia@provedor.com.br&bcc=copiaoculta@provedor.com.br&body=Quero fazer um orçamento de um elevador" className=" bg-cmi-4 rounded p-1"><FaRegEnvelope/></a>
                <a href="tel:+5519999555586" className=" bg-cmi-4 rounded p-1"><FaPhone/></a>
            </div>
        </footer>
    )
}
